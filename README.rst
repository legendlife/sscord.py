...
A modern, easy to use, feature-rich, and async ready API wrapper for Discord written in Python and a fork of discord.py.
...
.. code:: sh
    ...
    # Linux/macOS
    python3 -m pip install -U sscord.py

    # Windows
    py -3 -m pip install -U sscord.py
